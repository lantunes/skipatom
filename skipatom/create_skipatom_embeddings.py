...
from skipatom import Trainer, TrainingData


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--data", "-d", type=str, help="The path to the training data file."
    )
    parser.add_argument(
        "--out", "-o", type=str, help="The path to the embeddings file to be created."
    )
    parser.add_argument("--dim", type=int, help="The number of embedding dimensions.")
    parser.add_argument("--step", type=float, default=0.01, help="The step size.")
