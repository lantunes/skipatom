class ElemNetClassifier:
    def __init__(self, input_dim, activation="relu", l2_lambda=0.00001):
        ...
        self._model.add(
            Dense(1024, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(1024, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        ...
        self._model.add(
            Dense(512, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(512, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        ...
        self._model.add(
            Dense(256, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(256, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        ...
        self._model.add(
            Dense(128, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(128, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        ...
        self._model.add(
            Dense(64, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(64, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
            Dense(32, activation=activation, kernel_regularizer=l2(l2_lambda))
        )
        self._model.add(
